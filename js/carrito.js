...
const btnsComprar = document.querySelectorAll('.btn.btn-primary');
...
function eliminarProducto(e) {
  if (e.target.classList.contains('icon-close')) {
    ...
    const tituloProducto = productoElement.querySelector('.titulo-producto-carrito').textContent;

    // Encontrar el índice del producto a eliminar
    const index = productosEnCarrito.findIndex(producto => producto.titulo === tituloProducto);
    if (index !== -1) {
